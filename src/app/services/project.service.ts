...
export class ProjectService {
  ...
  projects: Project[] = [
    ...
    {id: 3, name:'Dating App', summary: 'A responsive blogging website built using Angular and Dot Net',description: 'Search for your partner and go on Date.',projectLink: "https://github.com/SharmaRajan", pictures: [], tags: [Tag.ANGULAR, Tag.HTML, Tag.CSS, Tag.BOOTSTRAP, Tag.ASPNET]},
    {id: 4, name:'Email Sender App', summary: 'A backend app built using Spring Boot and WebFlux',description: 'Send mail for User verification.',projectLink: "https://github.com/SharmaRajan", pictures: [], tags: [Tag.SPRINGBOOT, Tag.Java]},
    {id: 5, name:'Book Web App', summary: 'A Book Store website built using Servlets and JSP',description: 'Create books, update books, delete and get books.',projectLink: "https://github.com/SharmaRajan", pictures: [], tags: [Tag.SERVLETS, Tag.JSP, Tag.JDBC, Tag.HTML, Tag.CSS, Tag.BOOTSTRAP]},
    {id: 6, name:'User Management App', summary: 'User Management website built using Servlets and JSP',description: 'Create User, update users , get and delete.',projectLink: "https://github.com/SharmaRajan", pictures: [], tags: [Tag.SERVLETS, Tag.HTML, Tag.CSS, Tag.JSP, Tag.JDBC]},
    {id: 7, name:'Library Mangement App', summary: 'Library app is built using Spring Boot, Hibernate, JPA',description: 'Create books and Store it and assign it to the users those who want to read it.',projectLink: "https://github.com/SharmaRajan", pictures: [], tags: [Tag.SPRINGBOOT, Tag.HIBERNATE, Tag.JPA]},
